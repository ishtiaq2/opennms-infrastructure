...
Steps:
  ...
  2. Install CentOS, this guid uses CentOS-Stream-9-20260723.0-x86_64-boot.iso: https://odcs.stream.centos.org/production/latest-CentOS-Stream/compose/BaseOS/x86_64/iso/?utm_source=chatgpt.com
  3. sudo dnf update -y && sudo dnf install -y java-17-openjdk-devel maven git podman wget curl nano  
